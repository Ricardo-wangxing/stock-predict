...
my_sender = '1255483898@qq.com'    # 发件人邮箱账号
my_pass = 'npieymawhsaebadf'              # 发件人邮箱密码
my_user = '1255483898@qq.com'              # 收件人邮箱账号(这里发自己)
...
def mail(message):
    ...
    try:
        ...
        msg['From'] = formataddr(["server", my_sender])         # 发件人昵称
        msg['To'] = formataddr(["Wang", my_user])             # 接收人昵称
